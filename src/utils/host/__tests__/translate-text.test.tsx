...
describe("translate-text", () => {
  ...
  describe("executeTranslate", () => {
    ...
    it("should handle zero-width spaces correctly", async () => {
      ...
      expect(mockMicrosoftTranslate).toHaveBeenCalledWith("hello", "en", "zh", { textType: undefined })
    })
    ...
    it("should decode Google translateHtml entities", async () => {
      ...
      expect(mockGoogleTranslate).toHaveBeenCalledWith("test input", "en", "zh", { textType: undefined })
    })
  })
})
